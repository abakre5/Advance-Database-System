 ...
 */
public abstract class pnodePQPref {
    /**
    ...
    public int pnodeCMP(pnode a, pnode b)
        ...
        int ans = 0;
        try {
            ans = TupleUtils.CompareTupleWithTuplePref(a.tuple, fld_type, b.tuple, fld_type, len_in, str_sizes, pref_List, pref_List.length);
