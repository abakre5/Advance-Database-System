 ...
 */
public class pnodeSplayPQPref extends pnodePQPref {
...
//        sort_order = new TupleOrder(TupleOrder.Ascending);
     ...
     */
    public pnodeSplayPQPref(int[] _pref_list, AttrType[] fldType, TupleOrder order) {
        root = null;
        count = 0;
        this.pref_List = _pref_list;
        fld_type = fldType;
        sort_order = order;
    }
