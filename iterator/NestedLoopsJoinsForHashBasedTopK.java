...
public class NestedLoopsJoinsForHashBasedTopK extends Iterator {
     ...
     */
    public NestedLoopsJoinsForHashBasedTopK(AttrType in1[],
                                            int len_in1,
                                            short t1_str_sizes[],
                                            AttrType in2[],
                                            int len_in2,
        ...
        nOutFlds = n_out_flds;
        try {
            t_size = setup_op_tuple_extra_field(Jtuple, Jtypes,
                    in1, len_in1, in2, len_in2,
                    t1_str_sizes, t2_str_sizes,
                    proj_list, nOutFlds, new AttrType(AttrType.attrReal));
     ...
     */
    public static short[] setup_op_tuple_extra_field(Tuple Jtuple, AttrType[] res_attrs,
