 ...
 */
class DominatesDriver extends TestDriver implements GlobalConst {
    private int TRUE = 1;
    private int FALSE = 0;
    ...
    /**
     * DominatesDriver Constructor, inherited from TestDriver
     */
    public DominatesDriver() {
        super("DominatesTest");
    }
    ...
    public boolean test1() {
        ...
        try {
            status = TupleUtils.Dominates(t1, attrType, t2, attrType, (short) 2, attrSize, prefList, prefList.length);
            System.out.println("T1 Dominates T2: " + status);
            status = OK;
        } catch (Exception  e) {
            System.out.println("Error occurred while executing dominates => " +  e);
            e.printStackTrace();
            status = FAIL;
        }
    ...
    public boolean test3() {
        ...
        try {
            t1.setIntFld(1, 10);
            t1.setFloFld(2, 10.1f);
            t2.setIntFld(1, 1);
            t2.setFloFld(2, 10.1f);
        } catch (Exception e) {
            status = FAIL;
            e.printStackTrace();
        }
...
public class DominatesTest {

    public static void main(String[] args) {

        DominatesDriver dominatesDriver = new DominatesDriver();
        boolean dbstatus;

        dbstatus = dominatesDriver.runTests();
