 ...
 */
public abstract class ClusteredIndexFile {
    /**
     * Insert entry into the index file.
     *
     * @param data the key for the entry
     * @param pageId  the page id of the tuple with the key
     ...
     */
    abstract public void insert(final KeyClass data, final PageId pageId)
     ...
     *
     * @param data the key for the entry
     * @param pageId  the pageId of the tuple with the key
     * @throws IOException               from lower layers
     ...
     * @throws IndexSearchException      index search failed
     */
    abstract public boolean Delete(final KeyClass data, final PageId pageId)
