...
/**
 * BTClusteredFileScan implements a search/iterate interface to B+ tree
 * clustered index files (class BTreeClusteredFile).  It derives from abstract base
 * class IndexFileScan.
 */
    ...
    public KeyDataEntry get_next()
        ...
        try {
            ...
            while (entry == null) {
                ...
                leafPage = new BTClusteredLeafPage(nextpage, keyType);
